const h=5,v=6e5,x={none:["easy"],basic:["easy"],intermediate:["easy","medium"],advanced:["easy","medium","killer"]};function D(){try{const e=sessionStorage.getItem("survey");if(!e)return"none";const t=JSON.parse(e);return typeof(t==null?void 0:t.level)=="string"?t.level:"none"}catch{return"none"}}function g(){return x[D()]??["easy"]}function l(e){return(e==null?void 0:e.difficulty)??"easy"}const i=e=>`#include <stdio.h>
...
`,f=[{id:1,tag:"기초 · 산술",title:"두 수의 합",description:"정수 <code>A</code>가 입력으로 주어집니다. <code>A</code>와 <code>A + 1</code>의 합을 한 줄에 출력하는 프로그램을 작성하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"첫 줄에 <code>A + (A + 1)</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 10"],examples:[{input:"3",output:"7"},{input:"5",output:"11"}],aMin:1,aMax:10,aDefault:3,concepts:["vars","io","operators"],starter:i("A와 A+1의 합을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>e%2===0?"even":"odd"},{id:3,tag:"기본 · 반복문",title:"1부터 A까지의 합",description:"양의 정수 <code>A</code>가 주어집니다. <code>1</code>부터 <code>A</code>까지 모든 정수의 합을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>1 + 2 + ... + A</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"5",output:"15"},{input:"10",output:"55"}],aMin:1,aMax:100,aDefault:5,concepts:["loops","operators","io"],starter:i("1부터 A까지의 합을 출력하세요 (반복문 사용)"),solution:`#include <stdio.h>
...
`,expected:e=>{let t=0;for(let n=1;n<=e;n++)e%n===0&&t++;return String(t)}},{id:6,tag:"응용 · 재귀",title:"팩토리얼 A!",description:"양의 정수 <code>A</code>가 주어집니다. <code>A! = 1 × 2 × ... × A</code>의 값을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A!</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 10"],examples:[{input:"3",output:"6"},{input:"5",output:"120"}],aMin:1,aMax:10,aDefault:5,concepts:["recursion","functions","io"],starter:i("A 팩토리얼을 출력하세요 (재귀 함수 권장)"),solution:`#include <stdio.h>
...
`,expected:e=>{let t=1;for(let n=2;n<=e;n++)t*=n;return String(t)}},{id:7,tag:"응용 · 재귀",title:"피보나치 수 fib(A)",description:"양의 정수 <code>A</code>가 주어집니다. <code>fib(1) = 1</code>, <code>fib(2) = 1</code>이고 <code>fib(n) = fib(n-1) + fib(n-2)</code>로 정의되는 수열의 <code>A</code>번째 값을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>fib(A)</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 30"],examples:[{input:"1",output:"1"},{input:"10",output:"55"}],aMin:1,aMax:30,aDefault:10,concepts:["recursion","functions","loops"],starter:i("피보나치 수 fib(A)를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>{let t=1,n=1;for(let o=3;o<=e;o++){const c=t+n;t=n,n=c}return String(n)}},{id:8,tag:"기본 · 문자열",title:"별 A개 출력",description:"양의 정수 <code>A</code>가 주어집니다. <code>'*'</code> 문자를 <code>A</code>개 한 줄에 이어서 출력하세요. 예를 들어 <code>A = 4</code>면 <code>****</code>를 출력합니다.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>'*'</code>를 <code>A</code>개 출력합니다.",constraints:["1 ≤ A ≤ 50"],examples:[{input:"3",output:"***"},{input:"7",output:"*******"}],aMin:1,aMax:50,aDefault:5,concepts:["loops","strings","io"],starter:i("별 A개를 한 줄에 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>{if(e<2)return"not prime";for(let t=2;t*t<=e;t++)if(e%t===0)return"not prime";return"prime"}},{id:10,tag:"기초 · 산술",title:"A의 세제곱",description:"양의 정수 <code>A</code>가 주어집니다. <code>A의 세제곱(A × A × A)</code>을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A × A × A</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"2",output:"8"},{input:"5",output:"125"}],aMin:1,aMax:100,aDefault:5,concepts:["vars","operators","io"],starter:i("A의 세제곱을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(e*e*e)},{id:11,tag:"기본 · 문자열",title:"알파벳 A개 출력",description:"양의 정수 <code>A</code>가 주어집니다. <code>'a'</code>부터 시작해 알파벳 <code>A</code>개를 한 줄에 이어서 출력하세요. 예) <code>A = 3</code> → <code>abc</code>",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>'a'</code>부터 <code>A</code>개의 알파벳을 출력합니다.",constraints:["1 ≤ A ≤ 26"],examples:[{input:"3",output:"abc"},{input:"5",output:"abcde"}],aMin:1,aMax:26,aDefault:5,concepts:["loops","strings","vars","io"],starter:i("'a'부터 A개의 알파벳을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>"abcdefghijklmnopqrstuvwxyz".slice(0,e)},{id:12,tag:"기본 · 문자열",title:"Hello를 A번 출력",description:"양의 정수 <code>A</code>가 주어집니다. 문자열 <code>Hello</code>를 한 줄에 <code>A</code>번 이어서 출력하세요. 예) <code>A = 2</code> → <code>HelloHello</code>",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>Hello</code>를 <code>A</code>번 이어서 출력합니다.",constraints:["1 ≤ A ≤ 10"],examples:[{input:"2",output:"HelloHello"},{input:"3",output:"HelloHelloHello"}],aMin:1,aMax:10,aDefault:3,concepts:["loops","strings","functions","io"],starter:i("Hello를 A번 이어서 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>"Hello".repeat(e)},{id:13,tag:"응용 · 자릿수",title:"A의 자릿수 거꾸로 출력",description:"양의 정수 <code>A</code>가 주어집니다. <code>A</code>의 각 자릿수를 거꾸로 한 줄에 출력하세요. 예) <code>A = 1234</code> → <code>4321</code>",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>의 자릿수를 끝자리부터 차례로 출력합니다.",constraints:["10 ≤ A ≤ 99999"],examples:[{input:"1234",output:"4321"},{input:"98",output:"89"}],aMin:10,aMax:99999,aDefault:1234,concepts:["loops","strings","operators","vars"],starter:i("A의 자릿수를 거꾸로 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(e).split("").reverse().join("")},{id:14,tag:"응용 · 재귀",title:"1부터 A까지 합 (재귀)",description:"양의 정수 <code>A</code>가 주어집니다. <code>1 + 2 + ... + A</code>의 값을 <strong>재귀 함수</strong>로 계산해 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>1</code>부터 <code>A</code>까지의 합을 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"5",output:"15"},{input:"10",output:"55"}],aMin:1,aMax:100,aDefault:5,concepts:["recursion","functions","operators"],starter:i("재귀 함수로 1부터 A까지의 합을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(e*(e+1)/2)},{id:15,tag:"응용 · 재귀",title:"2의 A제곱 (재귀)",description:"<code>0</code> 이상의 정수 <code>A</code>가 주어집니다. <code>2의 A제곱(2^A)</code>을 <strong>재귀 함수</strong>로 계산해 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>2^A</code>의 값을 출력합니다.",constraints:["0 ≤ A ≤ 30"],examples:[{input:"0",output:"1"},{input:"10",output:"1024"}],aMin:0,aMax:30,aDefault:10,concepts:["recursion","functions","operators"],starter:i("재귀 함수로 2^A를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(2**e)},{id:16,tag:"응용 · 재귀",title:"하노이 탑 최소 이동 횟수",description:"원판 <code>A</code>개로 하노이 탑 문제를 풀 때 필요한 최소 이동 횟수 <code>2^A − 1</code>을 출력하세요. <strong>재귀 함수</strong>로 풀어보세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"최소 이동 횟수를 출력합니다.",constraints:["1 ≤ A ≤ 25"],examples:[{input:"1",output:"1"},{input:"5",output:"31"}],aMin:1,aMax:25,aDefault:5,concepts:["recursion","functions","operators"],starter:i("재귀로 하노이 탑 최소 이동 횟수를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(2**e-1)},{id:17,tag:"기본 · 문자열",title:"Z부터 A개 알파벳 거꾸로",description:"양의 정수 <code>A</code>가 주어집니다. <code>'Z'</code>부터 알파벳을 거꾸로 <code>A</code>개 한 줄에 출력하세요. 예) <code>A = 3</code> → <code>ZYX</code>",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>'Z'</code>부터 <code>A</code>개의 알파벳을 거꾸로 출력합니다.",constraints:["1 ≤ A ≤ 26"],examples:[{input:"3",output:"ZYX"},{input:"5",output:"ZYXWV"}],aMin:1,aMax:26,aDefault:5,concepts:["loops","strings","vars","io"],starter:i("'Z'부터 A개의 알파벳을 거꾸로 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>e.toString(2)},{id:19,tag:"기본 · 배열",title:"1부터 A까지 배열에 담아 출력",description:"양의 정수 <code>A</code>가 주어집니다. 길이가 <code>A</code>인 정수 배열에 <code>1, 2, ..., A</code>를 차례로 저장한 뒤, 공백으로 구분해 한 줄에 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>1</code>부터 <code>A</code>까지의 값을 공백으로 구분해 출력합니다.",constraints:["1 ≤ A ≤ 30"],examples:[{input:"3",output:"1 2 3"},{input:"5",output:"1 2 3 4 5"}],aMin:1,aMax:30,aDefault:5,concepts:["arrays","loops","io"],starter:i("길이 A 배열에 1~A를 저장하고 공백 구분으로 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>Array.from({length:e},(t,n)=>n+1).join(" ")},{id:20,tag:"기본 · 배열",title:"배열을 거꾸로 출력",description:"양의 정수 <code>A</code>가 주어집니다. 길이 <code>A</code>인 배열에 <code>1, 2, ..., A</code>를 저장한 뒤, 끝에서부터 거꾸로 한 줄에 공백 구분으로 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A, A-1, ..., 1</code>을 공백으로 구분해 출력합니다.",constraints:["1 ≤ A ≤ 30"],examples:[{input:"3",output:"3 2 1"},{input:"5",output:"5 4 3 2 1"}],aMin:1,aMax:30,aDefault:5,concepts:["arrays","loops","io"],starter:i("배열에 1~A를 저장한 뒤 거꾸로 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>Array.from({length:e},(t,n)=>e-n).join(" ")},{id:21,tag:"기본 · 배열",title:"제곱수의 합",description:"양의 정수 <code>A</code>가 주어집니다. 길이 <code>A</code>인 배열에 <code>1², 2², ..., A²</code>을 저장한 뒤 그 합을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>1² + 2² + ... + A²</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 50"],examples:[{input:"3",output:"14"},{input:"5",output:"55"}],aMin:1,aMax:50,aDefault:5,concepts:["arrays","loops","operators"],starter:i("배열에 1²~A²을 저장한 뒤 합을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(e*(e+1)/2)},{id:27,tag:"중급 · 포인터",title:"배열의 첫 원소와 끝 원소",description:"양의 정수 <code>A</code>가 주어집니다. 길이 <code>A</code>인 배열에 <code>1, 2, ..., A</code>를 저장한 뒤, 포인터로 첫 원소와 마지막 원소를 가리키고 두 값을 공백 구분으로 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>arr[0]</code>과 <code>arr[A-1]</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"5",output:"1 5"},{input:"1",output:"1 1"}],aMin:1,aMax:100,aDefault:5,concepts:["pointers","arrays","io"],starter:i("포인터로 첫 원소와 마지막 원소를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(e*(e+1))},{id:30,tag:"중급 · 구조체",title:"학생 점수 평균",description:"양의 정수 <code>A</code>가 주어집니다. 학생 <code>A</code>명의 점수가 각각 <code>1, 2, ..., A</code>일 때, <code>name</code>과 <code>score</code> 멤버를 가진 <code>Student</code> 구조체 배열에 저장한 뒤 <code>score</code>의 평균을 정수 나눗셈(소수점 버림)으로 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"점수의 평균(정수)을 출력합니다.",constraints:["1 ≤ A ≤ 50"],examples:[{input:"5",output:"3"},{input:"4",output:"2"}],aMin:1,aMax:50,aDefault:5,concepts:["structs","arrays","loops"],starter:i("Student 구조체 배열에 점수를 저장하고 평균을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(Math.floor(e*(e+1)/2/e))},{id:31,tag:"중급 · 동적 메모리",title:"malloc으로 배열 합",description:"양의 정수 <code>A</code>가 주어집니다. <code>malloc</code>으로 길이 <code>A</code>인 <code>int</code> 배열을 할당해 <code>1, 2, ..., A</code>를 저장하고 그 합을 출력한 뒤 <code>free</code>로 메모리를 반납하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>1 + 2 + ... + A</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"5",output:"15"},{input:"10",output:"55"}],aMin:1,aMax:100,aDefault:5,concepts:["memory","arrays","loops"],starter:i("malloc으로 배열을 잡고 합을 출력한 뒤 free하세요"),solution:`#include <stdio.h>
#include <stdlib.h>
...
`,expected:e=>String(e*(e+1)/2)},{id:32,tag:"중급 · 동적 메모리",title:"malloc으로 배열 거꾸로 출력",description:"양의 정수 <code>A</code>가 주어집니다. <code>malloc</code>으로 길이 <code>A</code>인 <code>int</code> 배열을 할당해 <code>A, A-1, ..., 1</code>을 차례로 저장하고 공백 구분으로 출력한 뒤 <code>free</code>하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A, A-1, ..., 1</code>을 공백으로 구분해 출력합니다.",constraints:["1 ≤ A ≤ 30"],examples:[{input:"3",output:"3 2 1"},{input:"5",output:"5 4 3 2 1"}],aMin:1,aMax:30,aDefault:5,concepts:["memory","arrays","loops"],starter:i("malloc으로 배열을 잡고 A,A-1,...,1을 저장한 뒤 free하세요"),solution:`#include <stdio.h>
#include <stdlib.h>
...
`,expected:e=>String(Math.ceil(e/2))},{id:34,tag:"기본 · 문자열",title:"strlen으로 길이 구하기",description:"양의 정수 <code>A</code>가 주어집니다. <code>char</code> 배열에 <code>'a'</code>를 <code>A</code>번 채우고 마지막에 <code>'\\0'</code>을 넣어 문자열로 만든 뒤, <code>strlen</code>으로 길이를 구해 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"만든 문자열의 길이를 출력합니다.",constraints:["1 ≤ A ≤ 50"],examples:[{input:"5",output:"5"},{input:"12",output:"12"}],aMin:1,aMax:50,aDefault:5,concepts:["strings","loops","io"],starter:i("'a'를 A번 채워 문자열을 만들고 strlen으로 길이를 출력하세요"),solution:`#include <stdio.h>
#include <string.h>
...
`,expected:e=>String(String(e).split("").reduce((t,n)=>t+Number(n),0))},{id:37,tag:"응용 · 문자열",title:"16진수로 출력",description:"양의 정수 <code>A</code>가 주어집니다. <code>A</code>를 16진수(소문자) 표현으로 출력하세요. 예) <code>A = 255</code> → <code>ff</code>",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>의 16진수 표현(소문자)을 출력합니다.",constraints:["1 ≤ A ≤ 4095"],examples:[{input:"10",output:"a"},{input:"255",output:"ff"}],aMin:1,aMax:4095,aDefault:255,concepts:["strings","io","operators"],starter:i("A를 16진수로 출력하세요 (%x 형식 지정자)"),solution:`#include <stdio.h>
...
`,expected:e=>String(e*3)},{id:39,tag:"기본 · 함수",title:"최댓값 함수 max",description:"양의 정수 <code>A</code>가 주어집니다. <code>int max(int x, int y)</code> 함수를 정의해 <code>max(A, 100 - A)</code>의 값을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"두 값 중 큰 쪽을 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"30",output:"70"},{input:"80",output:"80"}],aMin:1,aMax:100,aDefault:30,concepts:["functions","cond","io"],starter:i("max(A, 100-A)의 값을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(Math.abs(e-50))},{id:41,tag:"응용 · 재귀",title:"재귀로 카운트다운",description:"양의 정수 <code>A</code>가 주어집니다. 재귀 함수를 사용해 <code>A, A-1, ..., 1</code>을 공백으로 구분해 한 줄에 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>부터 <code>1</code>까지 거꾸로 출력합니다.",constraints:["1 ≤ A ≤ 30"],examples:[{input:"3",output:"3 2 1"},{input:"5",output:"5 4 3 2 1"}],aMin:1,aMax:30,aDefault:5,concepts:["recursion","functions","io"],starter:i("재귀 함수로 A부터 1까지 거꾸로 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>Array.from({length:e},(t,n)=>e-n).join(" ")},{id:42,tag:"응용 · 재귀",title:"최대공약수 (재귀 유클리드)",description:"양의 정수 <code>A</code>가 주어집니다. 재귀 함수 <code>gcd(a, b)</code>로 <code>gcd(A, 36)</code>의 값을 구해 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>와 <code>36</code>의 최대공약수를 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"24",output:"12"},{input:"5",output:"1"}],aMin:1,aMax:100,aDefault:24,concepts:["recursion","functions","operators"],starter:i("재귀 유클리드 호제법으로 gcd(A, 36)을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>{const t=(n,o)=>o===0?n:t(o,n%o);return String(t(e,36))}},{id:43,tag:"기초 · 자료형",title:"A번째 알파벳 출력",description:"양의 정수 <code>A</code>가 주어집니다. <code>'A'</code>를 1번째라고 할 때 <code>A</code>번째 대문자 알파벳을 출력하세요. (char와 int 사이 형변환 활용)",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>번째 대문자 알파벳을 출력합니다.",constraints:["1 ≤ A ≤ 26"],examples:[{input:"1",output:"A"},{input:"5",output:"E"}],aMin:1,aMax:26,aDefault:5,concepts:["vars","operators","io"],starter:i("'A' + (A - 1)을 char로 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String.fromCharCode(65+(e-1))},{id:44,tag:"기초 · 연산자",title:"비트 시프트로 2배",description:"양의 정수 <code>A</code>가 주어집니다. 비트 연산자 <code>&lt;&lt;</code>(왼쪽 시프트)를 사용해 <code>A</code>의 2배를 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A &lt;&lt; 1</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 1000"],examples:[{input:"5",output:"10"},{input:"100",output:"200"}],aMin:1,aMax:1e3,aDefault:5,concepts:["operators","vars","io"],starter:i("A << 1을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>e<=3?"low":e<=6?"mid":"high"},{id:46,tag:"기초 · 조건문",title:"삼항 연산자로 큰 수",description:"정수 <code>A</code>가 주어집니다. <strong>삼항 연산자</strong>(<code>?:</code>)를 사용해 <code>A</code>와 <code>50</code> 중 큰 값을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>와 <code>50</code> 중 큰 값을 출력합니다.",constraints:["0 ≤ A ≤ 100"],examples:[{input:"30",output:"50"},{input:"80",output:"80"}],aMin:0,aMax:100,aDefault:30,concepts:["cond","operators","io"],starter:i("삼항 연산자로 max(A, 50)을 출력하세요"),solution:`#include <stdio.h>
...
2 * 7 = 14
2 * 8 = 16
2 * 9 = 18`}],aMin:2,aMax:9,aDefault:3,concepts:["loops","operators","io"],starter:i("A단 구구단을 한 줄씩 출력하세요"),solution:`#include <stdio.h>
...
**
***`},{input:"1",output:"*"}],aMin:1,aMax:20,aDefault:4,concepts:["loops","strings","io"],starter:i("높이 A인 별 삼각형을 출력하세요 (중첩 반복문)"),solution:`#include <stdio.h>
...
`,expected:e=>`${e} ${e*2}`},{id:54,tag:"중급 · 구조체",title:"구조체 안의 배열 합",description:"양의 정수 <code>A</code>가 주어집니다. <code>int scores[3]</code> 멤버를 가진 <code>Student</code> 구조체에 <code>scores = {A, A + 1, A + 2}</code>를 채운 뒤 세 점수의 합을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"세 점수의 합(<code>3A + 3</code>)을 출력합니다.",constraints:["1 ≤ A ≤ 1000"],examples:[{input:"1",output:"6"},{input:"10",output:"33"}],aMin:1,aMax:1e3,aDefault:10,concepts:["structs","arrays","loops"],starter:i("Student 구조체 안의 scores 배열 합을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(3*e+3)},{id:55,tag:"중급 · 동적 메모리",title:"realloc으로 배열 키우기",description:"양의 정수 <code>A</code>가 주어집니다. 길이 1짜리 배열로 <code>malloc</code>한 뒤 <code>realloc</code>으로 길이 <code>A</code>까지 키우고, <code>1, 2, ..., A</code>를 저장한 후 합을 출력하고 <code>free</code>하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>1 + 2 + ... + A</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"5",output:"15"},{input:"10",output:"55"}],aMin:1,aMax:100,aDefault:5,concepts:["memory","arrays","loops"],starter:i("realloc으로 배열을 키운 뒤 합을 출력하세요"),solution:`#include <stdio.h>
#include <stdlib.h>
...
`,expected:e=>String(e*(e+1)/2)},{id:56,tag:"중급 · 동적 메모리",title:"동적 2차원 배열 대각선 합",description:"양의 정수 <code>A</code>가 주어집니다. <code>malloc</code>으로 <code>A × A</code> 크기의 2차원 <code>int</code> 배열을 동적 할당하고, 대각선 칸(<code>i == j</code>)만 1로, 나머지는 0으로 채운 뒤 모든 원소의 합을 출력하고 <code>free</code>하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"행렬 원소들의 합(= 대각선 길이 <code>A</code>)을 출력합니다.",constraints:["1 ≤ A ≤ 30"],examples:[{input:"3",output:"3"},{input:"5",output:"5"}],aMin:1,aMax:30,aDefault:4,concepts:["memory","arrays","loops"],starter:i("malloc으로 A x A 2차원 배열을 만들어 단위행렬을 채우세요"),solution:`#include <stdio.h>
#include <stdlib.h>
...
`,expected:e=>String(String(e).split("").reduce((t,n)=>t+Number(n),0))},{id:58,tag:"응용 · 재귀",title:"3의 거듭제곱 (재귀)",description:"<code>0</code> 이상의 정수 <code>A</code>가 주어집니다. <strong>재귀 함수</strong>로 <code>3^A</code>를 계산해 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>3의 A제곱</code> 값을 출력합니다.",constraints:["0 ≤ A ≤ 18"],examples:[{input:"0",output:"1"},{input:"5",output:"243"}],aMin:0,aMax:18,aDefault:5,concepts:["recursion","functions","operators"],starter:i("재귀로 3^A를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(3**e)},{id:59,tag:"응용 · 재귀",title:"재귀로 2진수 출력",description:"양의 정수 <code>A</code>가 주어집니다. <strong>재귀 함수</strong>로 <code>A</code>의 2진수 표현을 한 줄에 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>의 2진수 표현을 출력합니다.",constraints:["1 ≤ A ≤ 1023"],examples:[{input:"5",output:"101"},{input:"10",output:"1010"}],aMin:1,aMax:1023,aDefault:10,concepts:["recursion","functions","strings"],starter:i("재귀 함수로 A의 2진수 표현을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>e.toString(2)},{id:60,tag:"응용 · 문자열",title:"문자열 뒤집어 출력",description:"양의 정수 <code>A</code>가 주어집니다. <code>'a'</code>부터 시작해 <code>A</code>개의 알파벳을 <code>char</code> 배열에 채운 뒤, 배열 양 끝에서 인덱스를 교환하는 방법으로 문자열을 뒤집어 출력하세요. 예) <code>A = 4</code> → <code>abcd</code>를 만들어 뒤집은 결과 <code>dcba</code>.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"뒤집은 문자열을 출력합니다.",constraints:["1 ≤ A ≤ 26"],examples:[{input:"4",output:"dcba"},{input:"1",output:"a"}],aMin:1,aMax:26,aDefault:5,concepts:["strings","arrays","loops"],starter:i("char 배열에 'a'~'a'+A-1을 채우고 양 끝에서 swap해 뒤집으세요"),solution:`#include <stdio.h>
...
0 1 0
0 0 1`},{input:"1",output:"1"}],aMin:1,aMax:10,aDefault:3,concepts:["arrays","loops","cond"],starter:i("A x A 단위행렬을 줄 단위로 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>{const t=[];for(let n=0;n<e;n++){const o=[];for(let c=0;c<e;c++)o.push(n===c?"1":"0");t.push(o.join(" "))}return t.join(`
`)}},{id:64,tag:"기본 · 반복문",title:"do-while로 자릿수 합산",description:"<code>0</code> 이상의 정수 <code>A</code>가 주어집니다. <strong><code>do-while</code></strong> 반복문으로 <code>A</code>의 자릿수를 하나씩 떼어내며 합산해 출력하세요. <code>A = 0</code>인 경우 0이 출력되어야 하므로 <code>do-while</code>이 적절합니다.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"자릿수 합을 출력합니다.",constraints:["0 ≤ A ≤ 99999"],examples:[{input:"0",output:"0"},{input:"456",output:"15"}],aMin:0,aMax:99999,aDefault:456,concepts:["loops","operators","io"],starter:i("do-while로 자릿수 합을 계산해 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(e&1)},{id:66,tag:"기본 · 문자열",title:"strcat으로 문자열 이어붙이기",description:`양의 정수 <code>A</code>가 주어집니다. <code>"hi"</code> 뒤에 <code>'!'</code> 문자를 <code>A</code>번 <code>strcat</code>으로 이어붙인 결과를 출력하세요. 예) <code>A = 3</code> → <code>hi!!!</code>`,inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"이어붙인 문자열을 출력합니다.",constraints:["1 ≤ A ≤ 30"],examples:[{input:"1",output:"hi!"},{input:"3",output:"hi!!!"}],aMin:1,aMax:30,aDefault:3,concepts:["strings","loops","io"],starter:i(`strcat으로 "hi"에 '!'를 A번 이어붙이세요`),solution:`#include <stdio.h>
#include <string.h>
...
`,expected:e=>"hi"+"!".repeat(e)},{id:67,tag:"기초 · 조건문",title:"if-else로 점수 등급",description:"<code>0</code> 이상 <code>100</code> 이하의 정수 <code>A</code>가 주어집니다. <code>A &gt;= 90</code>이면 <code>A</code>, <code>80 &lt;= A &lt; 90</code>이면 <code>B</code>, <code>70 &lt;= A &lt; 80</code>이면 <code>C</code>, 그 외에는 <code>F</code>를 출력하세요. (다중 <code>if-else</code> 분기)",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"등급 한 글자를 출력합니다.",constraints:["0 ≤ A ≤ 100"],examples:[{input:"95",output:"A"},{input:"72",output:"C"},{input:"40",output:"F"}],aMin:0,aMax:100,aDefault:85,concepts:["cond","vars","io"],starter:i("점수 A에 따라 A/B/C/F 등급을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>"-".repeat(e)},{id:69,tag:"중급 · 포인터",title:"NULL 체크",description:"양의 정수 <code>A</code>가 주어집니다. <code>int *p = NULL</code>로 초기화한 뒤, 만약 <code>A</code>가 양수면 <code>p</code>가 <code>A</code>를 가리키도록 바꾸세요. 그 후 <code>p == NULL</code> 여부를 검사해 <code>NULL</code>이면 <code>null</code>, 아니면 <code>*p</code>의 값을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>*p</code> 값을 출력합니다(이 문제에서는 항상 양수이므로 <code>A</code>).",constraints:["1 ≤ A ≤ 1000"],examples:[{input:"5",output:"5"},{input:"100",output:"100"}],aMin:1,aMax:1e3,aDefault:5,concepts:["pointers","cond","io"],starter:i("NULL 체크 후 *p 또는 null을 출력하세요"),solution:`#include <stdio.h>
#include <stddef.h>
...
freed`}],aMin:1,aMax:100,aDefault:5,concepts:["memory","pointers","cond"],starter:i("malloc/free 후 NULL 대입과 NULL 체크까지 수행하세요"),solution:`#include <stdio.h>
#include <stdlib.h>
#include <stddef.h>
...
`,expected:e=>String(2*e)},{id:73,tag:"중급 · 동적 메모리",title:"동적 문자열 만들기",description:"양의 정수 <code>A</code>가 주어집니다. <code>malloc</code>으로 길이 <code>A + 1</code>인 <code>char</code> 배열을 할당해 <code>'a'</code>를 <code>A</code>번 채우고 마지막에 <code>'\\0'</code>을 넣어 문자열을 만든 뒤 출력하고 <code>free</code>하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"만든 문자열을 출력합니다.",constraints:["1 ≤ A ≤ 50"],examples:[{input:"3",output:"aaa"},{input:"5",output:"aaaaa"}],aMin:1,aMax:50,aDefault:5,concepts:["memory","strings","loops"],starter:i("malloc으로 길이 A+1의 char 배열을 만들어 문자열을 채우세요"),solution:`#include <stdio.h>
#include <stdlib.h>
...
`,expected:e=>String(Math.floor(e/2))},{id:75,tag:"기초 · 연산자",title:"복합 대입 연산자로 2의 거듭제곱",description:"<code>0</code> 이상의 정수 <code>A</code>가 주어집니다. <code>x</code>를 <code>1</code>로 시작해 <code>x *= 2</code>를 <code>A</code>번 반복한 뒤 <code>x</code>를 출력하세요. (결과: <code>2^A</code>)",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>2^A</code>의 값을 출력합니다.",constraints:["0 ≤ A ≤ 30"],examples:[{input:"0",output:"1"},{input:"5",output:"32"}],aMin:0,aMax:30,aDefault:5,concepts:["operators","loops","vars"],starter:i("x *= 2를 A번 반복해 2^A를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(2**e)},{id:76,tag:"기초 · 자료형",title:"문자의 ASCII 값",description:"양의 정수 <code>A</code>가 주어집니다. 알파벳 <code>'A'</code>부터 <code>A</code>번째 글자의 ASCII 값을 정수로 출력하세요. 예) <code>A = 1</code> → <code>'A'</code>의 ASCII값 <code>65</code>",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"ASCII 값을 정수로 출력합니다.",constraints:["1 ≤ A ≤ 26"],examples:[{input:"1",output:"65"},{input:"26",output:"90"}],aMin:1,aMax:26,aDefault:1,concepts:["vars","operators","io"],starter:i("'A'+(A-1)을 int로 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(e)},{id:81,tag:"기초 · 연산자",title:"비트 XOR로 마지막 비트 토글",description:"양의 정수 <code>A</code>가 주어집니다. <code>A ^ 1</code>(비트 XOR)을 계산해 출력하세요. 이 연산은 <code>A</code>의 마지막 비트를 뒤집습니다.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A ^ 1</code>의 값을 출력합니다.",constraints:["0 ≤ A ≤ 1000"],examples:[{input:"5",output:"4"},{input:"8",output:"9"}],aMin:0,aMax:1e3,aDefault:5,concepts:["operators","vars","io"],starter:i("A ^ 1의 값을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>{let t=1;for(;!(t*t>e);)t++;return String(t)}},{id:85,tag:"기초 · 자료형",title:"const 변수 사용",description:"양의 정수 <code>A</code>가 주어집니다. <code>const int PI3 = 314</code>로 상수를 선언한 뒤, <code>A * PI3</code>의 값을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A * 314</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 1000"],examples:[{input:"1",output:"314"},{input:"10",output:"3140"}],aMin:1,aMax:1e3,aDefault:1,concepts:["vars","operators","io"],starter:i("const int 상수를 선언해 사용하세요"),solution:`#include <stdio.h>
...
`,expected:e=>Array.from({length:e},(t,n)=>n+1).join(" ")},{id:87,tag:"기본 · 함수",title:"static 변수로 호출 횟수 세기",description:"양의 정수 <code>A</code>가 주어집니다. <code>int counter(void)</code> 함수를 정의해 내부에 <code>static int</code> 변수를 두고 호출마다 1 증가시켜 반환하도록 만든 뒤, 이 함수를 <code>A</code>번 호출하고 마지막 반환값을 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>번째 호출의 반환값(<code>A</code>)을 출력합니다.",constraints:["1 ≤ A ≤ 1000"],examples:[{input:"3",output:"3"},{input:"10",output:"10"}],aMin:1,aMax:1e3,aDefault:3,concepts:["functions","vars","loops"],starter:i("static 변수를 가진 counter()를 A번 호출하고 마지막 값을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(e)},{id:88,tag:"기초 · 연산자",title:"비트 OR로 두 비트 합치기",description:"양의 정수 <code>A</code>가 주어집니다. <code>A | (A &lt;&lt; 1)</code>의 값을 출력하세요. (<code>A</code>와 <code>2A</code>의 비트를 OR로 합친 결과)",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A | (A &lt;&lt; 1)</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 1000"],examples:[{input:"1",output:"3"},{input:"5",output:"15"}],aMin:1,aMax:1e3,aDefault:5,concepts:["operators","vars","io"],starter:i("A | (A << 1)의 값을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>e>=1&&e<=99?"yes":"no"},{id:90,tag:"응용 · 재귀",title:"최소공배수 (gcd 활용)",description:"양의 정수 <code>A</code>가 주어집니다. <strong>재귀로 정의된 <code>gcd</code></strong>를 만든 뒤, <code>lcm(A, 12) = A × 12 / gcd(A, 12)</code>를 계산해 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>lcm(A, 12)</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"4",output:"12"},{input:"5",output:"60"}],aMin:1,aMax:100,aDefault:5,concepts:["recursion","functions","operators"],starter:i("재귀 gcd로 lcm(A, 12)를 계산해 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>{const t=(n,o)=>o===0?n:t(o,n%o);return String(e*12/t(e,12))}},{id:91,tag:"응용 · 배열",title:"2차원 배열 행 합",description:"양의 정수 <code>A</code>가 주어집니다. <code>A × A</code> 2차원 배열의 <code>mat[i][j] = i + j</code>로 채운 뒤, 각 행의 합을 한 줄에 공백 구분으로 출력하세요. (i, j는 0부터)",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>개의 행 합을 공백으로 구분해 출력합니다.",constraints:["1 ≤ A ≤ 10"],examples:[{input:"3",output:"3 6 9"},{input:"2",output:"1 3"}],aMin:1,aMax:10,aDefault:3,concepts:["arrays","loops","operators"],starter:i("A x A 행렬을 i+j로 채우고 각 행의 합을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>{const t=[];for(let n=0;n<e;n++){let o=0;for(let c=0;c<e;c++)o+=n+c;t.push(o)}return t.join(" ")}},{id:92,tag:"기초 · 자료형",title:"enum으로 요일 번호 매기기",description:"<code>0</code> 이상 <code>6</code> 이하의 정수 <code>A</code>가 주어집니다. <code>enum Day { MON, TUE, WED, THU, FRI, SAT, SUN }</code>을 정의하고, <code>A</code>에 해당하는 요일을 짧은 이름(<code>MON</code>/<code>TUE</code>/...)으로 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"요일 약자를 출력합니다.",constraints:["0 ≤ A ≤ 6"],examples:[{input:"0",output:"MON"},{input:"5",output:"SAT"}],aMin:0,aMax:6,aDefault:2,concepts:["vars","cond","io"],starter:i("enum과 switch로 요일 약자를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>["MON","TUE","WED","THU","FRI","SAT","SUN"][e]},{id:93,tag:"중급 · 구조체",title:"중첩 구조체 (Rect의 중심점)",description:"양의 짝수 <code>A</code>가 주어집니다. <code>Point</code>(<code>x, y</code>)를 멤버로 갖는 <code>Rect</code>(<code>width, height, Point center</code>)를 정의하고, <code>width = A</code>, <code>height = A</code>, <code>center = (A/2, A/2)</code>로 초기화한 뒤 <code>center.x + center.y</code>를 출력하세요.",inputDesc:"첫 줄에 짝수 <code>A</code>가 주어집니다.",outputDesc:"<code>center.x + center.y</code>의 값(<code>A</code>)을 출력합니다.",constraints:["2 ≤ A ≤ 1000","A는 짝수"],examples:[{input:"4",output:"4"},{input:"10",output:"10"}],aMin:2,aMax:1e3,aDefault:4,concepts:["structs","vars","io"],starter:i("중첩 구조체로 center.x + center.y를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(2*Math.floor(e/2))},{id:94,tag:"중급 · 동적 메모리",title:"두 노드 연결 리스트 합",description:"양의 정수 <code>A</code>가 주어집니다. <code>value</code>와 <code>next</code> 멤버를 가진 <code>Node</code> 구조체를 두 개 <code>malloc</code>하고, 첫 번째 노드는 <code>value = A</code>, 두 번째는 <code>value = A + 1</code>로 연결한 뒤, 리스트를 순회하며 <code>value</code>들의 합을 출력하고 두 노드를 모두 <code>free</code>하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"두 노드 값의 합(<code>2A + 1</code>)을 출력합니다.",constraints:["1 ≤ A ≤ 1000"],examples:[{input:"5",output:"11"},{input:"10",output:"21"}],aMin:1,aMax:1e3,aDefault:5,concepts:["memory","structs","pointers"],starter:i("Node 두 개를 연결해 합을 출력하고 free하세요"),solution:`#include <stdio.h>
#include <stdlib.h>
#include <stddef.h>
...
`,expected:e=>String(2*e+1)},{id:95,tag:"응용 · 재귀",title:"재귀로 알파벳 출력",description:"양의 정수 <code>A</code>가 주어집니다. <strong>재귀 함수</strong>로 <code>'a'</code>부터 <code>A</code>개의 알파벳을 한 줄에 이어서 출력하세요. 예) <code>A = 4</code> → <code>abcd</code>",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>'a'</code>부터 <code>A</code>개 알파벳을 출력합니다.",constraints:["1 ≤ A ≤ 26"],examples:[{input:"3",output:"abc"},{input:"5",output:"abcde"}],aMin:1,aMax:26,aDefault:5,concepts:["recursion","functions","strings"],starter:i("재귀로 'a'부터 A개 알파벳을 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>"abcdefghijklmnopqrstuvwxyz".slice(0,e)},{id:96,tag:"기본 · 함수",title:"함수가 다른 함수 호출",description:"양의 정수 <code>A</code>가 주어집니다. <code>int twice(int x) { return x * 2; }</code>와 <code>int addTen(int x) { return twice(x) + 10; }</code>를 정의한 뒤, <code>addTen(A)</code>의 결과를 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>2A + 10</code>의 값을 출력합니다.",constraints:["1 ≤ A ≤ 1000"],examples:[{input:"3",output:"16"},{input:"5",output:"20"}],aMin:1,aMax:1e3,aDefault:3,concepts:["functions","operators","io"],starter:i("addTen(A) = twice(A) + 10의 값을 출력하세요"),solution:`#include <stdio.h>
...
**
*`},{input:"1",output:"*"}],aMin:1,aMax:20,aDefault:4,concepts:["loops","strings","operators"],starter:i("높이 A인 역삼각형(별)을 출력하세요"),solution:`#include <stdio.h>
...
`)},{id:101,tag:"중급 · 동적 메모리",title:"동적 배열로 평균",description:"양의 정수 <code>A</code>가 주어집니다. <code>malloc</code>으로 길이 <code>A</code>인 배열을 잡고 <code>1, 2, ..., A</code>를 저장한 뒤 평균(정수 나눗셈)을 출력하고 <code>free</code>하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>1 + 2 + ... + A</code>의 평균을 정수로 출력합니다.",constraints:["1 ≤ A ≤ 100"],examples:[{input:"5",output:"3"},{input:"4",output:"2"}],aMin:1,aMax:100,aDefault:5,concepts:["memory","arrays","operators"],starter:i("malloc 배열로 1~A 평균을 정수 출력하세요"),solution:`#include <stdio.h>
#include <stdlib.h>
...
`,expected:e=>String(Math.floor(e*(e+1)/2/e))},{id:102,tag:"중급 · 구조체",title:"두 Point 더하기",description:"양의 정수 <code>A</code>가 주어집니다. <code>Point</code> 구조체 두 개 <code>p1 = (A, A + 1)</code>과 <code>p2 = (1, 2)</code>를 만든 뒤, 각 좌표를 더해 합 좌표의 <code>x + y</code>를 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>(p1.x + p2.x) + (p1.y + p2.y)</code> 값(<code>2A + 4</code>)을 출력합니다.",constraints:["1 ≤ A ≤ 1000"],examples:[{input:"3",output:"10"},{input:"5",output:"14"}],aMin:1,aMax:1e3,aDefault:5,concepts:["structs","operators","io"],starter:i("두 Point를 더한 결과의 x+y를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:e=>String(e)},{id:104,tag:"응용 · 재귀",title:"재귀로 자릿수 개수",description:"양의 정수 <code>A</code>가 주어집니다. <strong>재귀 함수</strong>로 <code>A</code>가 몇 자리 수인지 출력하세요.",inputDesc:"첫 줄에 정수 <code>A</code>가 주어집니다.",outputDesc:"<code>A</code>의 자릿수 개수를 출력합니다.",constraints:["1 ≤ A ≤ 99999"],examples:[{input:"9",output:"1"},{input:"1234",output:"4"}],aMin:1,aMax:99999,aDefault:1234,concepts:["recursion","functions","operators"],starter:i("재귀로 A의 자릿수 개수를 출력하세요"),solution:`#include <stdio.h>
...
`,expected:({A:e,B:t})=>{let n=0,o=0;for(let c=e;c<=t;c++)c%2===0?n++:o++;return`${n} ${o}`}},{id:138,difficulty:"medium",tag:"중급 · 반복문",title:"1부터 N까지의 합과 곱",description:"양의 정수 <code>N</code>이 주어집니다. <code>1</code>부터 <code>N</code>까지의 합을 첫 줄에, <code>N!</code>(<code>1 × 2 × ... × N</code>)을 둘째 줄에 출력하세요.",inputDesc:"첫 줄에 정수 <code>N</code>이 주어집니다.",outputDesc:"두 줄에 걸쳐 합과 곱을 출력합니다.",constraints:["1 ≤ N ≤ 12"],examples:[{input:"3",output:`6
6`},{input:"5",output:`15
...
`,expected:({N:e})=>{let t=0,n=1;for(let o=1;o<=e;o++)t+=o,n*=o;return`${t}
...
`,expected:({A:e,B:t,C:n,D:o,E:c})=>{const d=e+t+n+o+c;return`${d}
...
`,expected:({N:e,M:t})=>{const n=[];for(let o=1;o<=e;o++){const c=[];for(let d=1;d<=t;d++)c.push(o*d);n.push(c.join(" "))}return n.join(`
...
`,expected:({N:e,M:t})=>{const n=[];if(e<=t)for(let o=e;o<=t;o++)n.push(o);else for(let o=e;o>=t;o--)n.push(o);return n.join(" ")}},{id:147,difficulty:"medium",tag:"중급 · 반복문",title:"Collatz 단계 수",description:"양의 정수 <code>N</code>이 주어집니다. <code>N</code>이 짝수면 <code>N = N / 2</code>, 홀수면 <code>N = 3N + 1</code>을 반복해 <code>N</code>이 <code>1</code>이 될 때까지 걸리는 횟수를 출력하세요.",inputDesc:"첫 줄에 정수 <code>N</code>이 주어집니다.",outputDesc:"<code>1</code>이 될 때까지 걸리는 단계 수를 출력합니다.",constraints:["1 ≤ N ≤ 100000"],examples:[{input:"1",output:"0"},{input:"6",output:"8"},{input:"27",output:"111"}],inputs:[{name:"N",min:1,max:1e5,desc:"시작 수"}],testCases:[{input:"1",expected:"0"},{input:"6",expected:"8"},{input:"27",expected:"111"}],concepts:["loops","cond","operators"],starter:`#include <stdio.h>
...
`}],m="codenergy:test:queue";function M(e,t=5){const n=new Set(e||[]),o=s=>{for(let r=s.length-1;r>0;r--){const A=Math.floor(Math.random()*(r+1));[s[r],s[A]]=[s[A],s[r]]}return s},c=new Set(g()),d=f.filter(s=>c.has(l(s))),u=o(d.filter(s=>Array.isArray(s.concepts)&&s.concepts.some(r=>n.has(r)))),a=new Set(u.map(s=>s.id)),p=o(d.filter(s=>!a.has(s.id)));return[...u,...p].slice(0,t).map(s=>s.id)}function B(){try{const e=sessionStorage.getItem(m);if(!e)return null;const t=JSON.parse(e);if(!Array.isArray(t)||t.length===0)return null;const n=t.filter(o=>f.some(c=>c.id===o));return n.length?n:null}catch{return null}}function y(e){try{sessionStorage.setItem(m,JSON.stringify(e))}catch{}}function N(e){if(Array.isArray(e.testCases)&&e.testCases.length>0)return e.testCases.map((d,u)=>({id:u+1,input:d.input,expected:d.expected,A:null,values:d.values??null}));if(l(e)==="medium"&&Array.isArray(e.inputs))return["min","mid","max"].map((u,a)=>{const p={},s=[];for(const r of e.inputs){const A=u==="min"?r.min:u==="max"?r.max:Math.floor((r.min+r.max)/2);p[r.name]=A,s.push(String(A))}return{id:a+1,input:s.join(`
`),expected:e.expected(p),A:null,values:p}});const t=e.aMin,n=e.aMax,o=Math.floor((t+n)/2);return(t===n?[t]:t+1===n?[t,n]:[t,o,n]).map((d,u)=>({id:u+1,input:String(d),expected:e.expected(d),A:d,values:null}))}export{f as P,m as Q,h as T,v as a,M as b,N as g,B as l,l as p,y as s};
